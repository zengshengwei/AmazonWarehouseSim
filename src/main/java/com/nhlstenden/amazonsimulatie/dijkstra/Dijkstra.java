...
//             if (!visited.contains(v.name)) { // kijkt of de opgehaade node (v) al is bezocht, zo ja -> overslaan
//                 edgeDistance = v.weight; // zet edgeDistance naar het gewicht van node (v)
//                 newDistance = dist[u] + edgeDistance; 
   
//                 // compare distances 
//                 if (newDistance < dist[v.name]) 
//                     dist[v.name] = newDistance; // als newDistance kleiner is dan het gewicht van de huidige node, zet newDistance in dist bij de index van v
   
//                 // Add the current node to the PriorityQueue 
//                 pqueue.add(new Node(v.name, dist[v.name]));
//             } 
//         } 
//     } 
// }
...
//         int v = 100; // aantal nodes om langs te gaan
//         int source = 0; 
...
//                 adj.get(i).add(new Node(nodeNum, 1));
//                 nodeNum++;
//             }
//         }
